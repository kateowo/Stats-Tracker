...
scoreboard objectives add custom.swim_one_cm minecraft.custom:swim_one_cm
scoreboard objectives add custom.aviate_one_cm minecraft.custom:aviate_one_cm
scoreboard objectives add custom.walk_on_water_one_cm minecraft.custom:walk_on_water_one_cm
scoreboard objectives add custom.walk_under_water_one_cm minecraft.custom:walk_under_water_one_cm
scoreboard objectives add custom.boat_one_cm minecraft.custom:boat_one_cm
scoreboard objectives add custom.fall_one_cm minecraft.custom:fall_one_cm
scoreboard objectives add custom.fly_one_cm minecraft.custom:fly_one_cm
scoreboard objectives add custom.sprint_one_cm minecraft.custom:sprint_one_cm
scoreboard objectives add custom.strider_one_cm minecraft.custom:strider_one_cm
scoreboard objectives add custom.sneak_time minecraft.custom:sneak_time
scoreboard objectives add custom.minecart_one_cm minecraft.custom:minecart_one_cm
scoreboard objectives add custom.horse_one_cm minecraft.custom:horse_one_cm
scoreboard objectives add custom.pig_one_cm minecraft.custom:pig_one_cm
